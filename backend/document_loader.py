        ...
        try:
            ...
            for doc in raw_docs:
                base_doc = {
                    ...
                    "grade": base_metadata.get("grade", ""),
                    "book_version": base_metadata.get("book_version", ""),
                    "resource_type": base_metadata.get("resource_type", "textbook"),
                    "section_title": base_metadata.get("section_title", ""),
                    "knowledge_tags": base_metadata.get("knowledge_tags", []),
                }
